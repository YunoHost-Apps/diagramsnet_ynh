...
**Version incluse :** 20.2.8~ynh1 *(:warning: Il s'agit de la branche `testing`. La [branche `master`](https://github.com/YunoHost-Apps/diagramsnet_ynh/tree/master) utilisée dans le catalogue est actuellement en 20.2.6\~ynh1.)*
