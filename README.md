...
**Shipped version:** 20.2.8~ynh1 *(:warning: This is the `testing` branch. The [`master` branch](https://github.com/YunoHost-Apps/diagramsnet_ynh/tree/master) used in the catalog is currently on version 20.2.6\~ynh1.)*
